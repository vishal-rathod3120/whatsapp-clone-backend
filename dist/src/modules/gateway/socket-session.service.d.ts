...
export declare class SocketSessionService {
    ...
    private sessions;
    private userSockets;
    constructor(prisma: PrismaService, presenceRepository: PresenceRepository, chatsService: ChatsService, messagesService: MessagesService, notificationsService: NotificationsService);
